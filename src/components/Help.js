            ...
            <div id="help">
                  ...
                  <div className="modal-content">
                    ...
                    <Modal.Body id="answer">
                      <p>
                        ...
                        moderate physical activity every day. If you want to
                        lose weight, maintain weight loss or meet specific
                        fitness goals, you may need to exercise more. Want to
                        aim even higher? You can achieve more health benefits if
                        you ramp up your exercise to 300 minutes or more a week.
                      </p>
                      <p>
                        Short on long chunks of time? Even brief bouts of
                        activity offer benefits. For instance, if you can't fit
                        in one 30-minute walk during the day, try a few
                        five-minute walks instead. Any activity is better than
                        none at all. What's most important is making regular
                      ...
                      <p className="reference">
                        ...
                        <a
                          className="link"
                          href="https://tinyurl.com/y9j9okn3"
                          target="_blank"
                ...
                >
                  <div className="modal-content">
                    ...
                    <Modal.Body id="answer">
                      ...
                      <p>
                        Skipping one or two high-calorie items is a good place
                        to start when cutting calories. For example, you could
                        skip your morning latte, soda at lunch or that bowl of
                        ice cream you always have after dinner. Think about what
                        you eat and drink each day and identify items you could
                        cut out. If you think that skipping your indulgence will
                        leave you with a craving, try a low-calorie
                        substitution.{" "}
                      </p>
                      <p className="reference">
                        {" "}
                        ...
                        <a
                          className="link"
                          href="https://tinyurl.com/yd8gkm2f"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                ...
                >
                  <div className="modal-content">
                    ...
                    <Modal.Body id="answer">
                      <p>
                        Bulking means that you're purposely trying to gain
                        weight (preferably muscle) and are therefore eating at a
                        caloric surplus. Cutting means that you're purposely
                        trying to lose weight (preferably fat) and are therefore
                        eating at a caloric deficit (and probably doing more
                        cardio).
                      </p>
                      <p>
                        The rate at which you bulk and cut, or how far you let
                        yourself go in terms of increased or decreased
                        bodyweight or bodyfat, are not yet standardized. For
                        example, “bulking” to one person might mean gaining 30
                        lbs in 6 weeks, whereas to another it might mean gaining
                        6 pounds in 6 weeks.
                      </p>
                      <p className="reference">
                        Contreras, Bret. 2014. "To Bulk And Cut Or Not To Bulk
                        And Cut." The Glute Guy.{" "}
                        <a
                          className="link"
                          href="https://tinyurl.com/y58l2c6z"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                  ...
                  <div className="modal-content">
                    ...
                    <Modal.Body id="answer">
                      <p>
                        ...
                        "intensity" is how much weight you choose. For each
                        weight training exercise set, perform 10 to 15
                      ...
                      <p>
                        ...
                        muscle-building stimulus. Those with significant
                        strength training experience may attempt more sessions.
                      </p>
                      <p className="reference">
                        ...
                        <a
                          className="link"
                          href="https://tinyurl.com/yy4k3525"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
